...
public class GetStr {
    public static void main(String[] args) {
       ...
       // System.out.println( operCond(divisionByDecimal(getStringByTypeM1(json, "WITHDRAW"),getStringByTypeM1(json,"DOMESTIC_PAYMENT")),">=",30));
        //System.out.println(divisionByDecimal("0.82",1));
        Map<String,Object> test = Maps.newHashMap();
        test.put("code","9999");
        test.put("msg","系统异常");
        test.put("merchantNo","12345678901");
        System.out.println(JSONObject.toJSONString(test));

        String merchantNo = (String) test.get("merchantNo1");
        //System.out.println(merchantNo.equals("1"));
